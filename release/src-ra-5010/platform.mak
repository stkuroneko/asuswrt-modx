...
define platformKernelConfig
	...
	if [ "$(SECOND_IF)" = "MT7612E" ] ; then \
		...
		if [ "$(RTN56UB1)" = "y" ] ||  [ "$(RTN56UB2)" = "y" ] || [ "$(RTMIR3G)" = "y" ] || [ "$(RTMIR3P)" = "y" ] || [ "$(RTMIR4A)" = "y" ] || [ "$(RTRM2100)" = "y" ] || [ "$(RTR2100)" = "y" ] || [ "$(RTNEWIFI2)" = "y" ] || [ "$(RTNEWIFI3)" = "y" ] || [ "$(RTHIWIFI4)" = "y" ] || [ "$(RTE8820S)" = "y" ]; then \
			sed -i "/CONFIG_RA_HW_NAT_IPV6/d" $(1); \
