...
define platformKernelConfig
	...
	if [ "$(SECOND_IF)" = "MT7612E" ] ; then \
		...
		if [ "$(RTN56UB1)" = "y" ] ||  [ "$(RTN56UB2)" = "y" ] || [ "$(RTMIR3G)" = "y" ] || [ "$(RTMIR3P)" = "y" ] || [ "$(RTMIR4A)" = "y" ] || [ "$(RTRM2100)" = "y" ] || [ "$(RTR2100)" = "y" ] || [ "$(RTNEWIFI2)" = "y" ] || [ "$(RTRS1200P)" = "y" ] || [ "$(RTXYC3)" = "y" ] || [ "$(RTNEWIFI3)" = "y" ] || [ "$(RTOPENFI5)" = "y" ] || [ "$(RTHIWIFI4)" = "y" ] || [ "$(RTE8820S)" = "y" ] || [ "$(RTE8820V2)" = "y" ] || [ "$(RTA040WQ)" = "y" ] || [ "$(RTMSG1500)" = "y" ] || [ "$(RTJDC1)" = "y" ] || [ "$(RTMT1300)" = "y" ] || [ "$(RTK2P)" = "y" ]; then \
			sed -i "/CONFIG_RA_HW_NAT_IPV6/d" $(1); \
	...
	if [ "$(RTAC85P)" = "y" ] || [ "$(RMAC2100)" = "y" ] || [ "$(RTNEWIFI2)" = "y" ] || [ "$(RTRS1200P)" = "y" ] || [ "$(RTXYC3)" = "y" ] || [ "$(RTNEWIFI3)" = "y" ] || [ "$(RTOPENFI5)" = "y" ] || [ "$(RTHIWIFI4)" = "y" ] || [ "$(RTE8820S)" = "y" ] || [ "$(RTE8820V2)" = "y" ] || [ "$(RTMIR3G)" = "y" ] || [ "$(RTJDC1)" = "y" || [ "$(RTMT1300)" = "y" ]; then \
