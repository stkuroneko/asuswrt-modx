...
#else 
#if defined(CONFIG_MODEL_RTNEWIFI2) || defined(CONFIG_MODEL_RTXYC3) || defined(CONFIG_MODEL_RTNEWIFI3) || defined(CONFIG_MODEL_RTJDC1) || defined(CONFIG_MODEL_RTMT1300)
