	...
	IN MAC_TABLE_ENTRY * pEntry)
{
	...
	*((USHORT *)&EapolKeyInfo) = cpu2le16(*((USHORT *)&EapolKeyInfo));
	...
	if (bReplayDiff) {
		...
		if (MsgType < EAPOL_GROUP_MSG_1)
			MTWF_LOG(DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Replay Counter Different in pairwise msg %d of 4-way handshake!\n", MsgType));
		else
			MTWF_LOG(DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_INFO, ("Replay Counter Different in group msg %d of 2-way handshake!\n", (MsgType - EAPOL_PAIR_MSG_4)));
