...
#elif defined(RTAC85U) || defined(RTMIR3P) || defined(RTE8820S) || defined(RTE8820V2) || defined(RTXYC3)
enum {
	WAN_PORT=4,
	LAN1_PORT=0,
	LAN2_PORT=1,
...
#define MT7621_GSW
#elif defined(RTAC85P)  || defined(RTACRH26) || defined(RTJDC1) || defined(RTOPENFI5)
enum {
	WAN_PORT=0,
	LAN1_PORT=1,
	LAN2_PORT=2,
...
#define MT7621_GSW
#elif defined(RTN800HP) || defined(RTHIWIFI4) || defined(RTA040WQ) || defined(RTNEWIFI3) || defined(RTMSG1500) || defined(RTMT1300) || defined(RTRS1200P) || defined(RTK2P)
enum {
	WAN_PORT=4,
	LAN1_PORT=3,
	LAN2_PORT=2,
