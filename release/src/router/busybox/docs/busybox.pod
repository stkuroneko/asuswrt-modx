...
Currently available applets include:
	...
	[, [[, arp, ash, awk, base64, basename, blkid, cat, chmod, chown,
	chpasswd, clear, cmp, cp, crond, cut, date, dd, devmem, df, dirname,
	dmesg, du, echo, egrep, env, ether-wake, expr, fdisk, fgrep, find,
	flash_eraseall, flock, free, fsck, fsck.minix, fsync, getopt, grep,
	gunzip, gzip, head, ifconfig, insmod, ionice, kill, killall, klogd,
	less, ln, logger, login, ls, lsmod, lsusb, md5sum, mdev, mkdir,
	mknod, mkswap, modprobe, more, mount, mv, netstat, nice, nohup,
	nslookup, pidof, ping, ping6, printf, ps, pwd, readlink, renice, rm,
	rmdir, rmmod, route, sed, setconsole, sh, shuf, sleep, sort,
	start-stop-daemon, strings, swapoff, swapon, sync, syslogd, tail,
	tar, telnetd, test, top, touch, tr, traceroute, traceroute6, true,
	udhcpc, umount, uname, uniq, unzip, uptime, usleep, vconfig, vi,
	watch, wc, which, xargs, zcat, zcip
