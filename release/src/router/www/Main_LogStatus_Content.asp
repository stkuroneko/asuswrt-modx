							...
							<tr>
								<td bgcolor="#4D595D" colspan="3" valign="top">
									...
									<div style="margin-top:8px">
										<textarea cols="63" rows="50" wrap="off" readonly="readonly" id="textarea" class="textarea_ssh_table" style="width:99%; font-family:'Courier New', Courier, mono; font-size:11px;"><% nvram_dump("syslog.log",""); %></textarea>
									</div>
									<div>
