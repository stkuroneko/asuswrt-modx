...
function isSupport(_ptn){
	if(_ptn == "rog"){
		...
		if(based_modelid == "RT-AC68U" && odmpid == "RP-AC1900"){
			return true;
		}
		else{
		...
		if(( based_modelid == "BRT-AC828" || based_modelid == "GT-AC5300" || based_modelid == "GT-AC9600" || based_modelid == "RT-AC5300" || based_modelid == "RT-AC3200" || based_modelid == "RT-AC3100" || 
			...
			based_modelid == "RT-NEWIFI2" || based_modelid == "RT-RS1200P" ||based_modelid == "RT-XYC3" ||based_modelid == "RT-NEWIFI3" || based_modelid == "RT-OPENFI5" || based_modelid == "RT-HIWIFI4" || based_modelid == "RT-A040WQ" || based_modelid == "RT-MSG1500" || based_modelid == "RT-JDC1" || based_modelid == "RT-MT1300" || based_modelid == "RT-K2P" ||
...
if((sw_mode == "2" && wlc_express == "0")|| sw_mode == "4"){
	if(wlc0_ssid != "" && wlc1_ssid != "" && concurrep_support){
		concurrent_pap = true;
		pap_flag = 1;
	}
}
