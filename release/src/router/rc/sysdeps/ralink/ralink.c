...
//				fprintf(fp, "HT_EXTCHA=%d\n", atoi(str));
	...
	//		warning = 34;
		...
		//HT_BSSCoexistence
#if defined(RMAC2100) || defined(RTA040WQ) || defined(RTMSG1500) || defined(RTMIR3G) || defined(RTE8820S) || defined(RTE8820V2) || defined(RTHIWIFI4) || defined(RTNEWIFI3) || defined(RTNEWIFI2) || defined(RTRS1200P) || defined(RTRM2100) || defined(RTR2100) || defined(RTMIR3P)
