...
#if defined(RTN56UB1) || defined(RTN56UB2) || defined(RTAC1200GA1) || defined(RTAC1200GU)|| defined(RTHIWIFI4) || defined(RTE8820S) || defined(RTE8820V2) || defined(RTA040WQ) || defined(RTMSG1500) || defined(RTK2P)
		modprobe(USB20_MOD);
#else
